...
def to_roman(val):
    # Список римских цифр и их соответствующих арабских значений
    roman_numerals = [
    ...
    # Проходим по списку римских цифр в порядке убывания их значения
    for arabic, roman in roman_numerals:
        while val >= arabic:  # Пока число больше или равно текущему арабскому значению
            roman_str += roman  # Добавляем соответствующую римскую цифру
            val -= arabic  # Уменьшаем число на значение этой цифры
